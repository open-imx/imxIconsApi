...
async def enforce_domain_whitelist(request: Request):  # pragma: no cover
...
def send_to_discord(feedback: Feedback):  # pragma: no cover
    payload = {
...
def validate_feedback(feedback: Feedback) -> bool:
    ...
    # Reject Request body with 'string' values (like in the docs)
...
def submit_feedback(request: Request, feedback: Feedback):  # pragma: no cover
    try:
